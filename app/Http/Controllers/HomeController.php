...
class HomeController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        if (request()->has('toggle')) {
            $cache = Cache::has($username.'_toggle');
            // dump($cache);
    ...
    public function showProfile(TeamUpdateRequest $request)
    {
        ...
        $area = Area::find(Auth::user()->area);
        return view(Helper::setViewForm('user', 'profile'))->with($this->share([
