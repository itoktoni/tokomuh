                ...
                <div class="col-md-6">
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-meta">
                            SKU : <span class="product-sku">{{ !empty($oproduct->item_product_sku) ? $oproduct->item_product_sku : 'Default' }}</span>
                            BRAND : <span
                        ...
                        @livewire('ecommerce.love-livewire', ['product_id' => $oproduct->item_product_id])
                        @livewire('ecommerce.variant-livewire', ['product_id' => $oproduct->item_product_id])
