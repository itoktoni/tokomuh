<div>
    ...
    <a class="sticky-link cart-toggle">
        <i class="minicart-icon icon-footer">
            <span class="cart-count icon-footer-count">{{ Cart::getTotalQuantity() }}</span>
        </i>
        <span>Cart</span>
    </a>
    <div class="dropdown-box">
            ...
            <div class="product product-cart">
                ...
                <figure class="product-media">
                    <a href="{{ route('product', ['slug' => $product_slug]) }}">
                        <img src="{{ Helper::files('product/'.$product_image) }}" alt="product" width="90"
                            height="90" />
                    </a>
        ...
        @else
        <div class="cart-action">
            <a href="{{ route('cart') }}" class="btn btn-dark"><span>Complete Cart</span></a>
        </div>
        @endif
