...
class ProvinceRepository extends Province implements MasterInterface
{
    ...
    public function getProvinceSeller(){
        return $this->join(BranchFacades::getTable(), 'branch_rajaongkir_province_id', $this->getKeyName());
    }
}
