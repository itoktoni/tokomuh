...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($form.'type') ? 'has-error' : ''}}">
        {{ Form::select($form.'type', ['left' => 'Text on Left', 'right' => 'Text on Right','center' => 'Text on Center', 'video' => 'Content Video'], null, ['class'=> 'form-control']) }}
        {!! $errors->first($form.'type', '<p class="help-block">:message</p>') !!}
    </div>

    {!! Form::label('name', 'Background', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has($form.'background') ? 'has-error' : ''}}">
        {!! Form::text($form.'background', null, ['class' => 'form-control jscolor']) !!}
        {!! $errors->first($form.'background', '<p class="help-block">:message</p>') !!}
    </div>
...
<div class="form-group">
    {!! Form::label('name', 'Page', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-10">
        {!! Form::textarea($form.'page', null, ['class' => 'form-control editor', 'rows' => '5']) !!}
    </div>
</div>