...
class Slider extends Model
{
  ...
  protected $fillable = [
    ...
    'marketing_slider_type',
    'marketing_slider_background',
    'marketing_slider_color',
  ];
  ...
  public $datatable = [
    ...
    'marketing_slider_type'        => [false => 'Type'],
    'marketing_slider_background'        => [false => 'Background'],
    'marketing_slider_color'        => [false => 'color'],
