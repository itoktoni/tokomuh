...
use App\Http\Livewire\Ecommerce\HomepageLivewire;
use App\Http\Livewire\Ecommerce\ProductLivewire;
use App\Http\Livewire\Ecommerce\ShopLivewire;
...
Route::match(['get', 'post'], 'profile', 'PublicController@profile')->name('profile');
Route::match(['get', 'post'], 'branch', 'PublicController@branch')->name('branch');
Route::match(['get', 'post'], 'account', 'PublicController@account')->name('account');
Route::match(['get', 'post'], 'wishlist', 'PublicController@wishlist')->name('wishlist');
...
Route::match(['get', 'post'],'/jual/{slug}', 'PublicController@oproduct')->name('product');
// Route::get('/jual/{slug}', [ProductLivewire::class, '__invoke'])->name('product');

Route::match(['get', 'post'],'/view/{slug}', 'PublicController@view')->name('view');
Route::match(['get', 'post'],'/auth', 'PublicController@auth')->name('auth');
...
Route::post('/subscribe','PublicController@subscribe')->name('subscribe');
